...
/**
 * Source Apache Tika:
 * https://github.com/apache/tika/blob/master/tika-core/src/main/java/org/apache/tika/utils/CharsetUtils.java
 */
@Component
public class CharsetUtils {
    ...
    private Map<String, Charset> initCommonCharsets(String... names) {
     ...
     */
    public String clean(String charsetName) {
        try {
