...
//        RequestContext context = parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER);
//
...
//
//        parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER);
//    }
//
//    @Test
...
//            () -> parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER));
//
//        assertEquals("Profile 'test-profile' already defines: [resolver, accessor]", ex.getMessage());
//    }
//
//    @Test
...
//
//        parameters.putSingle("X-GP-OPTIONS-THREAD-SAFE", "true");
//        context = new HttpRequestParser().parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER);
//        assertTrue(context.isThreadSafe());
//    }
//
//    @Test
...
//        RequestContext context = new HttpRequestParser().parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER);
...
//        RequestContext requestContext = parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.FRAGMENTER);
...
//        RequestContext context = parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.WRITE_BRIDGE);
...
//        RequestContext context = parser.parseRequest(mockRequestHeaders, RequestContext.RequestType.READ_BRIDGE);
