...
public class ConnectionManager {
    ...
    static final String CLEANUP_SLEEP_INTERVAL_NANOS_KEY = "pxf.plugin.jdbc.connection.cleanup-sleep-interval-nanos";
    ...
    public ConnectionManager(DataSourceFactory factory, Ticker ticker, DriverManagerWrapper driverManagerWrapper, Environment environment) {
        this.driverManagerWrapper = driverManagerWrapper;
        this.datasourceClosingExecutor = Executors.newCachedThreadPool();
        final long cleanupSleepIntervalNanos = environment.getProperty(CLEANUP_SLEEP_INTERVAL_NANOS_KEY, Long.class, CLEANUP_SLEEP_INTERVAL_NANOS);
     ...
     */
    @Component
    protected static class DataSourceFactory {
