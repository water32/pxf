...
//static void close_program_pipes(PxfCopyState cstate, bool ifThrow);
//CopyIntoClause*
...
//static volatile PxfCopyState glob_cstate = NULL;
...
///*
// * AXG: This one is equivalent to PxfCopySendEndOfRow() besides that
...
//
//		cstate = PxfBeginCopyFrom(pstate, rel, stmt->filename, stmt->is_program,
...
//			cstate->errMode = PXF_ALL_OR_NOTHING; /* default */
//		}
//
//		PG_TRY();
//		{
...
//	cstate = PxfBeginCopy(false, NULL, NULL, NULL, InvalidOid, copyIntoClause->attlist,
...
//	}
//
//	cstate = PxfBeginCopy(pstate, false, rel, query, queryRelId, attnamelist,
//					   options, NULL);
//	oldcontext = MemoryContextSwitchTo(cstate->copycontext);
//
//	/* Determine the mode */
...
//				 * We don't want to use PxfCopySendEndOfRow() b/c it adds row endings and
...
//			else
//			{
//				if (!PxfNextCopyFrom(cstate, econtext, myslot->tts_values, myslot->tts_isnull))
//					break;
//			}
//		}
...
//	 */
//	if ((cstate->errMode != PXF_ALL_OR_NOTHING && cstate->dispatch_mode == COPY_EXECUTOR)
//		|| cstate->on_segment)
//	{
//		SendNumRows((cstate->errMode != PXF_ALL_OR_NOTHING) ? cstate->cdbsreh->rejectcount : 0,
...
// */
//bool
//PxfNextCopyFromRawFields(PxfCopyState cstate, char ***fields, int *nfields)
//{
...
///*
// * Like PxfNextCopyFrom(), but used in the QD, when we want to parse the
...
// *
// * (The logic is actually within PxfNextCopyFrom(). This is a separate
...
//					 Datum *values, bool *nulls)
//{
//	return PxfNextCopyFrom(cstate, econtext, values, nulls);
//}
...
//static void
//close_program_pipes(PxfCopyState cstate, bool ifThrow)
//{
