...
SELECT image_test_images_in_different_directories.names, compare_table_images_in_different_directories.directories, image_test_images_in_different_directories.one_hot_encodings FROM image_test_images_in_different_directories, compare_table_images_in_different_directories
WHERE image_test_images_in_different_directories.fullpaths            = compare_table_images_in_different_directories.fullpaths
  ...
  AND image_test_images_in_different_directories.one_hot_encodings    = compare_table_images_in_different_directories.one_hot_encodings
...
SELECT image_test_images_in_different_directories_bytea.names, compare_table_images_in_different_directories_bytea.directories, image_test_images_in_different_directories_bytea.one_hot_encodings FROM image_test_images_in_different_directories_bytea, compare_table_images_in_different_directories_bytea
WHERE image_test_images_in_different_directories_bytea.fullpaths         = compare_table_images_in_different_directories_bytea.fullpaths
  ...
  AND image_test_images_in_different_directories_bytea.one_hot_encodings = compare_table_images_in_different_directories_bytea.one_hot_encodings
